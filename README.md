...
This site consists of vanilla HTML, CSS, and Javascript, so nothing other than a web server and a browser is required to run it.

### How to Use

Copy the files to the document root of your web server. If you wish to run this web site locally, you may use the Docker compose file provided and visit localhost:8080 to interact with the web page.
